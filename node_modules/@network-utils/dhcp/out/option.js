...
exports.UnknownOption = exports.BroadcastAddressOption = exports.ClassIdOption = exports.DomainServerOption = exports.GatewaysOption = exports.IpAddressListOption = exports.ClientIdentifierOption = exports.BootFileOption = exports.TftpServerOption = exports.RebindingTimeOption = exports.RenewalTimeOption = exports.AddressTimeOption = exports.SubnetMaskOption = exports.DHCPServerIdOption = exports.AddressRequestOption = exports.DomainNameOption = exports.HostnameOption = exports.DhcpMaxMsgSizeOption = exports.DhcpMessageOption = exports.ParameterListOption = exports.Utf8Option = exports.BufferOption = exports.NumberListOption = exports.IpAddressOption = exports.DHCPMessageTypeOption = exports.Uint32Option = exports.Uint16Option = exports.Uint8Option = exports.EndOption = exports.Option = void 0;
    ...
    static create(messageType) {
        ...
        switch (messageType) {
            ...
            case enum_1.DHCPOptions.BootFile:
                res = BootFileOption;
                break;
            case enum_1.DHCPOptions.BroadcastAddress:
...
class ClassIdOption extends Utf8Option {
    constructor(data) {
...
class BroadcastAddressOption extends IpAddressOption {
    constructor(data) {
        super(enum_1.DHCPOptions.BroadcastAddress, data);
    }
}
exports.BroadcastAddressOption = BroadcastAddressOption;
